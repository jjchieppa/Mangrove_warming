...
df<-read.csv("Mangrove FLvBZ long-term Q10 groups.csv")
...
for (reps in unique(dat$rep)){
  ...
  rect(dum$x, 0, dum$x+1, dum$Q10_LT)
  ablineclip(v = dum$x+0.5, y1 = dum$Q10_LT.lci, y2 = dum$Q10_LT.uci)
}
...
plot(1~0, pch = NA, xlim = c(0, 25), ylim = c(0,4.1), axes = F, xlab="",ylab=""); box()
axis(2, seq(0,4,1), las = 2, cex.axis = 1.1)
axis(1, at = dat$x+0.5, labels = 
       c("Am|FL","Am|BZ","Wa|FL","Wa|FL",
         "FL","BZ","Am","Wa","All",
         "Am|FL","Am|BZ","Wa|FL","Wa|FL",
         "FL","BZ","Am","Wa","All"), las = 2)
...
ablineclip(h = 1.9, x1=0,x2=12.25, lty = 2, col = "firebrick")
ablineclip(h = 2.7, x1=12.75,x2=25, lty = 2, col = "firebrick")
